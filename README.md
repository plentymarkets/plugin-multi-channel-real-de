...
# real.de plugin for plentymarkets 7.x

This is the real.de plugin developed by plentymarkets. real.de is already integrated in your plentymarkets 7 system.
